...
<div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Transaksi Setoran Bahan</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">Transaksi Setoran Bahan</li>
            </ol>
          </div>
        </div>
      </div>
...
<script>
  $(document).ready(function() {
        ...
        @if (Auth::user()->divisi!="pembelian")
          $("div.test_btn").html('<a class="btn btn-lg btn-md btn-success" href="{{url('setor/create')}}"> <i class="fas fa-plus fa-sm md-3" ></i></a');
        @endif
    });
</script>
@endsection