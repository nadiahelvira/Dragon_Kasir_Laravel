...
class AccountController extends Controller
{
	...
	public function browsehut(Request $request)
    {

		   $account = DB::SELECT("SELECT NO_BUKTI AS NO_HUT, TOTAL AS JUMLAH, KODES AS KODES, NAMAS AS NAMAS, NAMAS AS URAIAN, TGL AS TGL,
                                BANK_REK AS BANK_REK, NOTES2, NOTES3, NOTES4, NOTES5, PPH, PPH2, PPH3, PPH4, KL, 'DISK'
                                FROM hut
                                WHERE FLAG = 'HT' 
                                AND NO_KASIR <>''
                                ORDER BY NO_BUKTI");
