...
<div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
            <h1 class="m-0">Edit Data Ks-Slip {{$KODE}}</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{url('/wila')}}">Master Ks-Slip</a></li>
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{url('/wila/update/'.$NO_ID)}}" method="POST" id="entri">
                        @csrf
                        ...
                        <div class="tab-content mt-3">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    placeholder="Masukkan Kode" value="{{$KODE}}" readonly>
                                </div>      
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    placeholder="Masukkan Rek#" value="{{$NO_REK}}" >
                                </div>      
							...
							<div class="form-group row">
									...
									<div class="col-md-4">
										<input type="text" class="form-control ALAMAT" id="ALAMAT" name="ALAMAT" placeholder="-" value="{{$ALAMAT}}" >
									</div>                             
							</div>
							...
							<div class="form-group row">
									...
									<div class="col-md-4">
										<input type="text" class="form-control KOTA" id="KOTA" name="KOTA" placeholder="-" value="{{$KOTA}}" >
									</div>                             
							</div>
							...
							<div class="form-group row">
									...
									<div class="col-md-4">
										<input type="text" class="form-control TELPON" id="TELPON" name="TELPON" placeholder="-" value="{{$TELPON}}" >
									</div>                             
							</div>
							...
							<div class="form-group row">
									...
									<div class="col-md-4">
										<input type="text" class="form-control JENIS" id="JENIS" name="JENIS" placeholder="-" value="{{$JENIS}}" >
									</div>                             
							</div>
