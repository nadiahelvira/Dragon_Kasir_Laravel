                            ...
                            <div class="form-group row">
                                <div class="col-md-1">
                                 ...
                                 <div class="col-md-2 input-group" >
                                  <input type="text" class="form-control BACNO" id="BACNO" name="BACNO" placeholder="Masukkan Bacno" value="{{$header->BACNO ?? ''}}"  style="text-align: left" readonly >
                                 </div>
							...
							<table id="datatable" class="table table-striped table-border">                
								<thead>
                                    <tr>
										...
										<th {{( $flagz =='BKK') ? '' : 'hidden' }} width="400px" style="text-align:center">No Hut</th>
                                        <th width="400px" style="text-align:center">Uraian</th>					
                                        <th width="150px" style="text-align:center">Jumlah</th>
								...
								@foreach ($detail as $detail)
                                    <tr>
										...
										<td {{( $flagz =='BKK') ? '' : 'hidden' }}>
                                            <input name="NO_HUT[]" id="NO_HUT{{$no}}" type="text" value="{{$detail->NO_HUT}}"
                                            class="form-control NO_HUT" readonly>
                                        </td>
...
///////////////////////////////////////
	...
	function cekBukti(no_bukti) {
                ...
                $.ajax({
                    ...
                    error: function() {
                        alert('Error cekBukti Kas occured');
                    }
                });
                return hasilCek;
    }
    ...
    function tambah() {
		...
		html=`<tr>
                ...
                <td {{( $flagz =='BBK') ? '' : 'hidden' }}>
				    <input name='NO_HUT[]'   data-rowid=${idrow} id='NO_HUT${idrow}' type='text' class='form-control  NO_HUT' readonly>
                </td>
                <td>
				...
				<td>
		            <input name='JUMLAH[]'  onblur='hitung()' id='JUMLAH${idrow}' type='text' style='text-align: right' class='form-control JUMLAH text-primary' required >
                </td>
