...
<div class="content-wrapper">
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
               <h1 class="m-0">Edit BG {{$NO_BUKTI}}</h1>	
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{url('/bg')}}">BG</a></li>
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{url('/bg/update/'.$NO_ID)}}" id="entri" method="POST">
                        @csrf
                        ...
                        <div class="tab-content mt-3">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input type="text" class="form-control SERIES" id="SERIES" name="SERIES" value="{{$SERIES}}" placeholder="Masukkan Series" >
                                </div>
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4 input-group" >
                                  <input type="text" class="form-control PERUSAHAAN" id="PERUSAHAAN" name="PERUSAHAAN" placeholder="Masukkan No Rekening" value="{{$PERUSAHAAN}}" style="text-align: left" >
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4 input-group" >
                                  <input type="text" class="form-control NOREK" id="NOREK" name="NOREK" placeholder="Masukkan No Rekening" value="{{$NOREK}}" style="text-align: left" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4 input-group" >
                                  <input type="text" class="form-control PENERIMA" id="PENERIMA" name="PENERIMA" placeholder="Masukkan Penerima" value="{{$PENERIMA}}" style="text-align: left" >
                                ...
                                <div class="col-md-4 input-group" >
                                  <input type="text" class="form-control NM_PENGIRIM" id="NM_PENGIRIM" name="NM_PENGIRIM" placeholder="Masukkan Nama Pengirim" value="{{$NM_PENGIRIM}}" style="text-align: left" >
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4 input-group" >
                                  <input type="text" class="form-control ALM_PENERIMA" id="ALM_PENERIMA" name="ALM_PENERIMA" placeholder="Masukkan Alamat" value="{{$ALM_PENERIMA}}" style="text-align: left" >
                                ...
                                <div class="col-md-4 input-group" >
                                  <input type="text" class="form-control ALM_PENGIRIM" id="ALM_PENGIRIM" name="ALM_PENGIRIM" placeholder="Masukkan Alamat" value="{{$ALM_PENGIRIM}}" style="text-align: left" >
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4 input-group" >
                                  <input type="text" class="form-control BANK_PENERIMA" id="BANK_PENERIMA" name="BANK_PENERIMA" placeholder="Masukkan Alamat" value="{{$BANK_PENERIMA}}" style="text-align: left" >
                                ...
                                <div class="col-md-3 input-group" >
                                  <input type="text" class="form-control TELP_PENGIRIM" id="TELP_PENGIRIM" name="TELP_PENGIRIM" placeholder="Masukkan Telp" value="{{$TELP_PENGIRIM}}" style="text-align: left" >
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4 input-group" >
                                  <input type="text" class="form-control ALM_BANK" id="ALM_BANK" name="ALM_BANK" placeholder="Masukkan Alamat" value="{{$ALM_BANK}}" style="text-align: left" >
                                ...
                                <div class="col-md-3 input-group" >
                                  <input type="text" class="form-control NOREK_PENGIRIM" id="NOREK_PENGIRIM" name="NOREK_PENGIRIM" placeholder="Masukkan Alamat" value="{{$NOREK_PENGIRIM}}" style="text-align: left" >
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-2" align="left">
                                    <input type="text" class="form-control JUMLAH" id="JUMLAH" name="JUMLAH" placeholder="JUMLAH" value="{{$JUMLAH}}" style="text-align: right" >
                                </div>
                                ...
                                <div class="col-md-3 input-group" >
                                  <input type="text" class="form-control PEMBAYARAN" id="PEMBAYARAN" name="PEMBAYARAN" placeholder="Masukkan Keterangan" value="{{$PEMBAYARAN}}" style="text-align: left" >
