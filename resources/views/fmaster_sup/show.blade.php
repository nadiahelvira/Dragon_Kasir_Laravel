...
<div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
            <h1 class="m-0">Lihat Data Suplier</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{url('/sup')}}">Master Suplier</a></li>
                <li class="breadcrumb-item active">{{$KODES}}</li>
            </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                        ...
                        <div class="tab-content mt-3">
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    placeholder="Masukkan Nama Suplier" value="{{$NAMAS}}" readonly>
                                </div>                                
                            </div>
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    placeholder="Masukkan Kota" value="{{$KOTA}}" readonly>
                                </div>
                            </div>
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    placeholder="Masukkan Telpon" value="{{$TELPON1}}" readonly>
                                </div>
                            </div>
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    placeholder="Masukkan Fax" value="{{$FAX}}" readonly>
                                </div>
                            </div>
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    placeholder="Masukkan HP" value="{{$HP}}" readonly>
                                </div>
								
                                <div class="col-md-4">
                                    <input type="checkbox" class="form-check-input" id="AKT"name="AKT"
                                    placeholder="Masukkan Aktif/Tidak" value="1" {{ ($AKT == 1) ? 'checked' : '' }} readonly>
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    placeholder="Masukkan Kontak" value="{{$KONTAK}}" readonly>
                                </div>
                            </div>
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    placeholder="Masukkan Email" value="{{$EMAIL}}" readonly>
                                </div>
                            </div> 
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    placeholder="Masukkan NPWP" value="{{$NPWP}}" readonly>
                                </div>
                            </div>
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    placeholder="Masukkan Ket" value="{{$KET}}" readonly>
                                </div>
                            </div>
							...
							<div id="bankInfo" class="tab-pane">
								...
								<div class="form-group row">
									...
									<div class="col-md-4">
										<input type="text" class="form-control BANK" id="BANK" name="BANK" placeholder="Masukkan Bank" value="{{$BANK}}" readonly>
									</div>                                
								</div>
								...
								<div class="form-group row">							       
									...
									<div class="col-md-4">
										<input type="text" class="form-control BANK_CAB" id="BANK_CAB" name="BANK_CAB" placeholder="Masukkan Cabang" value="{{$BANK_CAB}}" readonly>
									</div>
								</div>
								...
								<div class="form-group row">							       
									...
									<div class="col-md-4">
										<input type="text" class="form-control BANK_KOTA" id="BANK_KOTA" name="BANK_KOTA" placeholder="Masukkan Kota" value="{{$BANK_KOTA}}" readonly>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-4">
										<input type="text" class="form-control BANK_NAMA" id="BANK_NAMA" name="BANK_NAMA" placeholder="Masukkan Nama" value="{{$BANK_NAMA}}" readonly>
									</div>                                
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-4">
										<input type="text" class="form-control BANK_REK" id="BANK_REK" name="BANK_REK" placeholder="Masukkan Nomor Rekening" value="{{$BANK_REK}}" readonly>
									</div>                                
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-4">
										<input type="text" class="form-control HARI" id="HARI" name="HARI" placeholder="Masukkan Jumlah Hari" value="{{$HARI}}" readonly>
									</div>                                
								</div>
