...
<!--// ganti 2 -->
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="store" method="POST" enctype="multipart/form-data" id="entri">
                        @csrf
                        ...
                        <div class="tab-content mt-3">
							<div class="form-group row">
									...
									<div class="col-md-2">
										<label for="BNK" class="form-label">HD</label>
									</div>
									<div class="col-md-4">
							...
							<div class="form-group row">
                                ...
                                <!-- <div class="form-group row">
									<div class="col-md-2">
										<label for="PIC01" class="form-label">Gambar</label>
									</div>

									<div class="col-md-3">									
                                       <input type="file" accept="uploads/account/x-png,uploads/account/gif,uploads/account/jpeg" name="PIC01" size="20" onchange="document.getElementById('PIC01').src = window.URL.createObjectURL(this.files[0])" />
                                       <img id="PIC01" alt="Preview" width="200" height="100" />
									</div>
