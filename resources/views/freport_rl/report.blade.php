				...
				<div class="card">
					<div class="card-body">
						...
						<div class="form-group row">
							<div class="col-md-2" align="left"><strong style="font-size: 13px;">Periode</strong></div>
							<div class="col-md-2">
						...
						<div class="form-group row">
							...
							<div class="col-md-2" align="left"><strong style="font-size: 13px;">Jenis Laporan</strong></div>
							<div class="col-md-2">
								<select name="PILIH" id="PILIH" class="form-control PILIH" style="width: 200px">
									<option value="1" {{ ( session()->get('filter_pilih') == '1') ? 'selected' : '' }} >Rugi Laba Berjalan</option>
									<option value="2" {{ ( session()->get('filter_pilih') == '2') ? 'selected' : '' }} >Rugi Laba Akumulasi</option>
								</select>
							</div>
						</div>
