...
<div class="content-wrapper">     
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
            <h1 class="m-0">Tambah Setoran Bahan Baku</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="/setor">Transaksi Setoran Bahan Baku </a></li>
                    ...
                    <form action="store" method="POST">
                        ...
                        <div class="tab-content mt-3">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control NO_BUKTI" id="NO_BUKTI" name="NO_BUKTI" placeholder="Masukkan Bukti#" value=""  >
                                </div>
                            ...
                            <table id="datatable" class="table table-striped table-border">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input name="KD_BRG[]" id="KD_BRG0" type="text" class="form-control KD_BRG" >
                                        </td>
                                        <td>
										...
										<td><input name="QTY[]"  onblur="hitung()" value="0" id="QTY0" type="text" style="text-align: right" 
    										class="form-control QTY" ></td>
                    										
										<td><input name="HARGA[]"  onblur="hitung()" value="0" id="HARGA0" type="text" style="text-align: right" 
    										class="form-control HARGA" ></td>
                    										
										<td><input name="TOTAL[]"  value="0" id="TOTAL0" type="text" style="text-align: right" 
    										class="form-control TOTAL" readonly></td>
                    									

                                        <td>
                                            <input name="BB_BP[]" id="BB_BP0" type="text" class="form-control BB_BP" readonly required>
                                        </td>
...
//////////////////////////////////////////////////////////////////
    ...
    function tambah() {
        ...
        td4.innerHTML = "<input name='SATUAN[]'   id=SATUAN" + idrow + " type='text' class='form-control  SATUAN' required readonly>";
 		...
 		td7.innerHTML = "<input name='TOTAL[]'   value='0' id=TOTAL" + idrow + " type='text' style='text-align: right' class='form-control TOTAL  text-primary' readonly >";
