	...
	<div class="content-wrapper">
		...
		<div class="container-fluid">
			<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0">Oper BBK BBM 1 Nomor</h1>
			</div>
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
				<li class="breadcrumb-item active">Ganti BBK BBM 1 Nomor</li>
				</ol>
			</div>
			</div>
		</div>
		...
		<div class="content">
			...
			<div class="row">
				...
				<div class="card">
					<div class="card-body">
						<form method="POST" action="{{url('roperbbmbbk_1nomor/jasper-operbbmbbk_1nomor-report')}}" name ="entri" id="entri" >
						@csrf
