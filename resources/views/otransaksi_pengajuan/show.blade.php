...
<div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
            <h1 class="m-0">Lihat Journal Kas Masuk</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{url('/kas')}}">Journal Kas Masuk</a></li>
                    ...
                    <form action="store" method="POST">
						...
						<!-- <div class="col-md-2">
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control KET" id="KET" name="KET" placeholder="Masukkan Dari/Ke" value="{{$header->KET}}" readonly>
                                </div>
                            </div>
                            ...
                            <table id="datatable" class="table table-striped table-border">
								...
								@foreach ($detail as $kasd)
                                    <tr>
										...
										<td>
                                            <input name="JUMLAH[]" onclick="select()" onkeyup="hitung()" id="JUMLAH0" type="text" style="text-align: right" value="{{number_format($kasd->JUMLAH, 2)}}"
								...
								<tfoot>
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td><input class="form-control TJUMLAH  text-primary font-weight-bold" style="text-align: right"  id="TJUMLAH" name="TJUMLAH" value="{{number_format($header->JUMLAH, 2)}}" readonly></td>
                                    <td></td>
                                </tfoot>
