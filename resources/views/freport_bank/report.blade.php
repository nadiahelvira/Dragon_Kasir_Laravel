			...
			<div class="row">
				...
				<div class="card">
					<div class="card-body">
						...
						@csrf
						<!-- <label><strong>Jenis Bank :</strong></label>
						<div class="form-group nowrap">
							<select name="TYPE" id="TYPE" class="form-control TYPE" style="width: 200px">
								<option value="">Semua</option>
								<option value="BBM">Masuk</option>
								<option value="BBK">Keluar</option>
							</select>
						</div>
						<div class="form-group nowrap">
						...
						<div class="form-group row">
							...
							<div class="col-md-2">
								<select name="TYPE" id="TYPE" class="form-control TYPE" style="width: 200px">
									<option value="-">Semua</option>
									<option value="BBM" {{ ( session()->get('filter_type') == 'BBM') ? 'selected' : '' }}   >Masuk</option>
									<option value="BBK" {{ ( session()->get('filter_type') == 'BBK') ? 'selected' : '' }} >Keluar</option>
								</select>
							</div>
							...
							<div class="col-md-1">
								<label for="CAIR" class="form-label">Cair</label>
							</div>
							<div class="col-md-2">
								<select name="CAIR" id="CAIR" class="form-control CAIR" style="width: 200px">
									<option value="-" {{ ( session()->get('filter_cair') == '-') ? 'selected' : '' }} >Semua</option>
									<option value="1" {{ ( session()->get('filter_cair') == '1') ? 'selected' : '' }} >Cair</option>
									<option value="0" {{ ( session()->get('filter_cair') == '0') ? 'selected' : '' }} >Belum Cair</option>
								</select>
							</div>
                        </div>
						...
						<div class="form-group row">
							...
							<div class="col-md-2">
								<select name="PILIH" id="PILIH" class="form-control PILIH" style="width: 200px">
									<option value="1" {{ ( session()->get('filter_pilih') == '1') ? 'selected' : '' }} >Journal Bank</option>
									<option value="2" {{ ( session()->get('filter_pilih') == '2') ? 'selected' : '' }} >Register Bank</option>
									<option value="3" {{ ( session()->get('filter_pilih') == '3') ? 'selected' : '' }} >Bank Pendek Per Bukti</option>
									<option value="4" {{ ( session()->get('filter_pilih') == '4') ? 'selected' : '' }} >Bank Per Nomor Bukti</option>
								</select>
							</div>
						</div>
