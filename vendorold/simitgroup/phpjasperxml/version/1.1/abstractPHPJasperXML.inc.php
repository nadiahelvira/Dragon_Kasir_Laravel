...
//                     $out["target"]= $this->analyse_expression( $out['target'], true);
        ...
        protected function formatText($txt='',$pattern='') 
        {
             // echo "$txt $pattern</br>";
        if($pattern=="###0")
            return number_format((float)$txt,0,"","");
        elseif($pattern=="#,##0")
            return number_format((float)$txt,0,".",",");
        elseif($pattern=="###0.0")
            return number_format((float)$txt,1,".","");
        elseif($pattern=="#,##0.0" || $pattern=="#,##0.0;-#,##0.0")
            return number_format((float)$txt,1,".",",");
        elseif($pattern=="###0.00" || $pattern=="###0.00;-###0.00")
            return number_format((float)$txt,2,".","");
        elseif($pattern=="#,##0.00" || $pattern=="#,##0.00;-#,##0.00")
            return number_format((float)$txt,2,".",",");
        elseif($pattern=="###0.00;(###0.00)")
            return ($txt<0 ? "(".number_format(abs((float)$txt),2,".","").")" : number_format((float)$txt,2,".",""));
        elseif($pattern=="#,##0.00;(#,##0.00)")
            return ($txt<0 ? "(".number_format(abs((float)$txt),2,".",",").")" : number_format((float)$txt,2,".",","));
        elseif($pattern=="#,##0.00;(-#,##0.00)")
            return ($txt<0 ? "(".number_format((float)$txt,2,".",",").")" : number_format((float)$txt,2,".",","));
        
        elseif($pattern=="###0.000")
            return number_format((float)$txt,3,".","");
        elseif($pattern=="#,##0.000")
            return number_format((float)$txt,3,".",",");
        elseif($pattern=="#,##0.0000")
            return number_format((float)$txt,4,".",",");
        elseif($pattern=="###0.0000")
            return number_format((float)$txt,4,".","");
        elseif($pattern=="#,##0.00000")
            return number_format((float)$txt,5,".",",");
        elseif($pattern=="#,##0.000000")
            return number_format((float)$txt,6,".",",");
        elseif($pattern=="#,##0.0000000")
            return number_format((float)$txt,7,".",",");
        elseif($pattern=="#,##0.00000000")
            return number_format((float)$txt,8,".",",");
        elseif($pattern=="###0.00000")
            return number_format((float)$txt,5,".","");        
        elseif($pattern=="dd/MM/yyyy" && (float)$txt !="")
