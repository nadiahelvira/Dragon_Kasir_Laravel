  ...
  $(document).ready(function() {
   ...
   //     $("div.test_btn").html('<a class="btn btn-lg btn-md btn-success" href="{{url('kas/edit?flagz='.$flagz.'&idx=0&tipx=new')}}"> <i class="fas fa-plus fa-sm md-3" ></i></a');
	...
	var dTableBKas;
        ...
        $("div.test_btn").html('<a class="btn btn-lg btn-md btn-success" href="{{url('kas/edit?flagz='.$flagz.'&idx=0&tipx=new')}}"> <i class="fas fa-plus fa-sm md-3" ></i> TAMBAH BARU </a>'+ 
		'<a></a> <a class="btn btn-lg btn-md btn-success" href="{{url('kas/createdatabkk')}}"> <i class="fas fa-plus fa-sm md-3" ></i> PROSES DATA BKK </a>' + 
		'<a></a> <a class="btn btn-lg btn-md btn-success" onclick="browseKas()"></i> Cari </a>'  );
