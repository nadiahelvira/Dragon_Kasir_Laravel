                    ...
                    <form action="storedatabkk" id="entri"  method="POST">
                        ...
                        <div class="tab-content mt-3">
							...
							<div class="form-group row">
								...
								<div class="col-md-4">										
									<a type="button" onclick="getKasPms()" class="btn btn-success">CARI DATA PMS</a>
                                </div>
                            </div>
							...
							<div class="form-group row">
								...
								<div class="col-md-4">
									<button type="submit" onclick="return simpanx()" class="btn btn-success" name="isi"><i class="fa fa-save"></i> ISI OTOMATIS</button>
                                </div>
                            </div>
                        ...
                        <div class="mt-3">
                            <div class="form-group row">
								...
								-->
									<button type="submit" class="btn btn-success"><i class="fa fa-save" name="proses"></i> PROSES</button>
                                </div>
							</div>
                        </div>
                    </form>
				...
				success: function( resp )
				{
					...
					for(i=0; i<resp.length; i++){
						html+=`<tr>
                                    ...
                                    <td><input name='BKK_PWK[]' data-rowid=${i} id='BKK_PWK${i}' value="${resp[i].BKK_PWK}" type='text' class='form-control BKK_PWK'  readonly ></td>
                                    <td><input name='NO_BUKTI[]' data-rowid=${i} id='NO_BUKTI${i}' value="${resp[i].NO_BUKTI}" type='text' class='form-control  NO_BUKTI' readonly></td>
                                    <td><input name='TGL[]' data-rowid=${i} id='TGL${i}' value="${resp[i].TGL}" type='text' class='form-control  TGL' readonly></td>
                                    <td><input name='URAIAN[]' data-rowid=${i} id='URAIAN${i}' value="${resp[i].URAIAN}" type='text' class='form-control URAIAN'  readonly ></td>
                                    <td><input name='KET[]' data-rowid=${i} id='KET${i}' value="${resp[i].KET}" type='text' class='form-control KET'  readonly ></td>
                                    <td><input name='JUMLAH[]' onblur="hitung()" id='JUMLAH${i}' value="${resp[i].JUMLAH}" type='text' style='text-align: right' class='form-control JUMLAH text-primary' required></td>
                                    <td><input name='TGL_AMBIL[]' data-rowid=${i} id='TGL_AMBIL${i}' value="${resp[i].TGL_AMBIL}" type='text' class='form-control  TGL_AMBIL' readonly></td>
