	...
	<div class="content-wrapper">
		...
		<div class="container-fluid">
			<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0">Laporan Ratio</h1>
			</div>
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
				<li class="breadcrumb-item active">Laporan Ratio</li>
				</ol>
			</div>
			</div>
		</div>
		...
		<div class="content">
			...
			<div class="row">
				...
				<div class="card">
					<div class="card-body">
						<form method="POST" action="{{url('rratio/jasper-ratio-report')}}" >
						@csrf
						<!--
						...
						<div class="form-group row">
							...
							<div class="col-md-1" align="left"><strong style="font-size: 13px;">Tgl Cetak :</strong></div>
							<div class="col-md-2">
						...
						<button class="btn btn-danger" type="button" id="resetfilter" class="resetfilter" onclick="window.location='{{url("rratio")}}'">Reset</button>
